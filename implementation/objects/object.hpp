...
//class Object;
//
//using CamIterator = std::vector<std::shared_ptr<Object>>::iterator;
...
////
////    virtual bool remove(const CamIterator &) { return false; };
////
////    virtual CamIterator begin() { return CamIterator(); };
////
////    virtual CamIterator end() { return CamIterator(); };
////
